...
Se vuoi vivere il Palio, prenota il soggiorno con largo anticipo: la terza domenica di settembre è l'evento più atteso dell'anno.`,
    ...
    linkInterni: [
      ...
      { label: 'Scopri le nostre offerte food & wine', href: '/prenota', icon: 'fa-tag' },
    ],
    prev: null,
    next: 'alba',
  },
...
Se vuoi vivere Canelli con calma e visitare anche Alba, Asti e il Monferrato, soggiorna da noi: siamo la base ideale per un weekend enogastronomico completo.`,
    ...
    linkInterni: [
      ...
      { label: 'Scopri le nostre offerte wine tour', href: '/prenota', icon: 'fa-tag' },
    ],
    prev: 'alba',
...
Per evitare stress e perdere meno tempo negli spostamenti, chiedi alla reception: costruiamo un itinerario su misura e gestiamo le prenotazioni con partner convenzionati.`,
    ...
    linkInterni: [
      ...
      { label: 'Scopri le offerte food & wine', href: '/prenota', icon: 'fa-tag' },
    ],
...
Dal castello che domina Costigliole d\'Asti fino ai manieri immersi nei vigneti UNESCO, ogni tappa è un viaggio nella storia che si intreccia con il paesaggio vitivinicolo più iconico del Piemonte.`,
    ...
    linkInterni: [
      ...
      { label: 'Scopri offerte weekend tra castelli e cantine', href: '/prenota', icon: 'fa-tag' },
    ],
...
In autunno, quando le vigne si tingono di rosso e arancione, le fotografie che si scattano sono di una bellezza assoluta. Pianifica la tua visita per approfittare dei colori stagionali più spettacolari.`,
    ...
    linkInterni: [
      { label: 'Camere Quadruple, Portate i Bambini!', href: '/camere/quadrupla', icon: 'fa-child' },
      ...
      { label: 'Pacchetto Weekend, 2 Notti e Panchine', href: '/prenota', icon: 'fa-tag' },
    ],
...
È la soluzione ideale per coppie, famiglie e piccoli gruppi che vogliono vivere il paesaggio senza stress: vigne, strade bianche, panorami UNESCO e borghi autentici.`,
        ...
        tags: ['E-bike', 'Girobike', 'Turismo lento'],
      },
      {
...
Nei tour autoguidati vengono fornite tracce GPX da caricare sullo smartphone con app gratuite: il tracciato si segue in modo intuitivo. In alternativa, puoi richiedere un accompagnamento professionale per scoprire strade secondarie e punti meno conosciuti.`,
        ...
        tags: ['GPX', 'Guida qualificata', 'Percorsi personalizzati'],
      },
      {
...
Per ogni itinerario possiamo consigliarti soste enogastronomiche e punti panoramici ideali per fotografie e pause.`,
        ...
        tags: ['Percorsi E-bike', 'Canelli', 'Monferrato'],
      },
      {
...
Se desideri massimo comfort, il nostro team può organizzare per te l’intera esperienza con servizi accessori (incluso transfer, quando richiesto), così non devi pensare a nulla se non a goderti il territorio.`,
        ...
        tags: ['Itinerario su misura', 'Transfer', 'Esperienza organizzata'],
      },
    ],
    infoPratiche: {
    ...
    linkInterni: [
      { label: 'Contattaci per il tour E-bike su misura', href: '/contatti', icon: 'fa-envelope' },
      { label: 'Prenota il soggiorno e organizza l’esperienza', href: '/prenota', icon: 'fa-calendar-check' },
      { label: 'Scopri altre attività nel territorio', href: '/territorio', icon: 'fa-map' },
    ],
    prev: 'big-bench',
...
Ogni birra nasce dall’equilibrio tra tecnica e sensibilità artigianale, con stili che valorizzano profumi, pulizia aromatica e bevibilità.`,
        ...
        tags: ['Birra artigianale', 'Produzione locale', 'Qualità'],
      },
      {
...
Durante il percorso vengono spiegate in modo chiaro tutte le fasi produttive, dalla macinazione alla fermentazione, con focus su ingredienti, stili e differenze sensoriali.`,
        ...
        tags: ['Tour birrificio', 'Mastro birraio', 'Degustazione'],
      },
      {
...
Al termine è possibile acquistare le birre direttamente nello spaccio aziendale.`,
        ...
        tags: ['Offerta esperienza', 'Beer tasting', 'Spaccio aziendale'],
      },
      {
...
Per il massimo comfort non è necessario organizzare nulla in autonomia: possiamo coordinare noi tutta la visita in base al tuo programma.`,
        ...
        tags: ['Nizza Monferrato', 'Esperienza locale', 'Itinerario combinato'],
      },
    ],
    infoPratiche: {
    ...
    linkInterni: [
      { label: 'Contattaci per organizzare la visita al birrificio', href: '/contatti', icon: 'fa-envelope' },
      { label: 'Prenota il soggiorno e vivi l’esperienza completa', href: '/prenota', icon: 'fa-calendar-check' },
      { label: 'Scopri anche la guida E-bike nel Monferrato', href: '/territorio/ebike-monferrato', icon: 'fa-bicycle' },
    ],
...
Per chi visita il Monferrato, è un’occasione ideale per conoscere da vicino il Nizza DOCG, denominazione di eccellenza che rappresenta una delle forme più evolute della Barbera piemontese.`,
        ...
        links: [
          { label: 'Sito ufficiale Nizza è Barbera', href: 'https://nizzaebarbera.wine/' },
          { label: 'Nizza Monferrato, Google Maps', href: 'https://maps.google.com/?q=Nizza+Monferrato' },
        ],
        tags: ['Nizza è Barbera', 'Evento vino Piemonte', 'Nizza Monferrato'],
      },
      {
...
Accanto al vino, la parte gastronomica è fondamentale: tra stand, locali e ristoranti puoi assaggiare specialità locali come la Belecauda (farinata nicese) e altri piatti della tradizione piemontese.`,
        ...
        tags: ['Barbera Forum', 'Degustazione Nizza DOCG', 'Food & Wine Monferrato'],
      },
      {
...
Nei giorni della manifestazione l’affluenza è elevata: consigliamo di partire con anticipo e parcheggiare nelle aree esterne al centro, per poi proseguire a piedi verso i punti evento.`,
        ...
        links: [
          { label: 'Percorso Hotel → Nizza Monferrato (Google Maps)', href: 'https://maps.google.com/?saddr=Hotel+Langhe+Monferrato+Costigliole+d%27Asti&daddr=Nizza+Monferrato' },
        ],
        tags: ['Come arrivare a Nizza Monferrato', 'Parcheggi evento', 'Gita da Costigliole'],
      },
      {
...
È un tragitto breve ma ricco di panorami straordinari: filari, borghi e castelli che raccontano l’identità vitivinicola del Monferrato. Al rientro, ti aspetta il relax in hotel per chiudere la giornata nel modo migliore.`,
        ...
        tags: ['Wine tour Monferrato', 'Vigne UNESCO', 'Weekend enogastronomico'],
      },
      {
        titolo: 'FAQ: date, prenotazioni e consigli utili',
        testo: `La manifestazione si svolge ogni anno indicativamente nel secondo weekend di maggio, solitamente intorno all’8-10 maggio. Le date ufficiali vengono pubblicate dagli organizzatori sul sito dell’evento.

Per vivere al meglio la manifestazione, il suggerimento è prenotare con anticipo sia il soggiorno sia eventuali masterclass o accessi dedicati alle degustazioni più richieste.

Consulta il sito ufficiale per le date aggiornate di ogni edizione.`,
        lista: [
          'Quando: in genere secondo weekend di maggio, solitamente intorno all’8-10 maggio (verifica le date sul sito ufficiale)',
        ...
        links: [
          { label: 'Date e programma ufficiale — nizzaebarbera.wine', href: 'https://nizzaebarbera.wine/' },
        ],
        tags: ['Nizza è Barbera', 'FAQ evento vino', 'Prenotare weekend Monferrato'],
      },
    ],
    infoPratiche: {
    ...
    linkInterni: [
      { label: 'Prenota il tuo soggiorno per Nizza è Barbera', href: '/prenota', icon: 'fa-calendar-check' },
      { label: 'Contattaci per organizzare il tuo weekend wine', href: '/contatti', icon: 'fa-envelope' },
      { label: 'Scopri altre guide del territorio', href: '/territorio', icon: 'fa-map' },
    ],

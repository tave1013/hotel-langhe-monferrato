...
Wenn Sie den Palio erleben möchten, buchen Sie Ihren Aufenthalt weit im Voraus: Der dritte Sonntag im September ist das meisterwartete Ereignis des Jahres.`,
    ...
    linkInterni: [
      ...
      { label: 'Entdecken Sie unsere Wein- & Genussangebote', href: '/prenota', icon: 'fa-tag' },
    ],
    prev: null,
    next: 'alba',
  },
...
Wenn Sie Canelli in aller Ruhe genießen und auch Alba, Asti und das Monferrato besuchen möchten, übernachten Sie bei uns: Wir sind eine ideale Basis für ein vollständiges Wein-&-Genuss-Wochenende.`,
    ...
    linkInterni: [
      ...
      { label: 'Entdecken Sie unsere Weintouren-Angebote', href: '/prenota', icon: 'fa-tag' },
    ],
    prev: 'alba',
...
Vom Schloss über Costigliole d'Asti bis zu den Festungen inmitten von UNESCO-Weinbergen ist jede Station eine Reise durch Geschichte, verflochten mit Piemonts ikonischster Weinlandschaft.`,
    ...
    linkInterni: [
      ...
      { label: 'Entdecken Sie Wochenendangebote zwischen Schlössern und Weingütern', href: '/prenota', icon: 'fa-tag' },
    ],
...
Im Herbst, wenn die Weinberge sich rot und orange färben, sind die Fotos außergewöhnlich schön. Planen Sie Ihren Besuch, um die spektakulärsten saisonalen Farben zu genießen.`,
    ...
    linkInterni: [
      ...
      { label: 'Wochenendpaket: 2 Nächte und Bänke', href: '/prenota', icon: 'fa-tag' },
    ],
...
Es ist eine kurze Route voller außergewöhnlicher Blicke: Weinreihen, Dörfer und Schlösser, die die Weinidentität des Monferrato erzählen. Zurück im Hotel genießen Sie vollständige Entspannung, um den Tag auf die beste Weise abzuschließen.`,
      ...
      {
        titolo: 'FAQ: Termine, Buchungen und nützliche Tipps',
        testo: `Die Veranstaltung findet jedes Jahr am zweiten Maiwochenende statt, üblicherweise rund um den 8.–10. Mai. Die offiziellen Termine werden jedes Jahr von den Veranstaltern auf der Website des Events veröffentlicht.
...
Aktuelle Termine jeder Ausgabe finden Sie auf der offiziellen Website.`,
        lista: [
          'Wann: normalerweise zweites Maiwochenende, üblicherweise rund um den 8.–10. Mai (offizielle Termine auf der Website prüfen)',
        ...
        links: [
          { label: 'Offizielle Termine und Programm — nizzaebarbera.wine', href: 'https://nizzaebarbera.wine/' },
        ],
        tags: ['Nizza è Barbera', 'Weinveranstaltungs-FAQ', 'Monferrato-Wochenende buchen'],
      },
    ],
    infoPratiche: {

...
Si quieres vivir el Palio, reserva tu estancia con mucha antelación: el tercer domingo de septiembre es el evento más esperado del año.`,
    ...
    linkInterni: [
      ...
      { label: 'Descubra nuestras ofertas enogastronómicas', href: '/prenota', icon: 'fa-tag' },
    ],
    prev: null,
    next: 'alba',
  },
...
Si quieres vivir Canelli con tranquilidad y también visitar Alba, Asti y Monferrato, quédate con nosotros: somos la base ideal para un fin de semana enológico completo.`,
    ...
    linkInterni: [
      ...
      { label: 'Descubre nuestras ofertas de tours enológicos', href: '/prenota', icon: 'fa-tag' },
    ],
    prev: 'alba',
...
Para evitar el estrés y perder menos tiempo en viajes, pregunta en recepción: elaboramos un itinerario a medida y gestionamos las reservas con socios afiliados.`,
    ...
    linkInterni: [
      ...
      { label: 'Descubre las ofertas enogastronómicas', href: '/prenota', icon: 'fa-tag' },
    ],
...
Desde el castillo que domina Costigliole d\\'Asti hasta las mansiones inmersas en los viñedos de la UNESCO, cada parada es un viaje a través de la historia entrelazada con el paisaje vitivinícola más emblemático del Piamonte.`,
    ...
    linkInterni: [
      ...
      { label: 'Descubre ofertas de fin de semana entre castillos y bodegas', href: '/prenota', icon: 'fa-tag' },
    ],
...
En otoño, cuando los viñedos se tiñen de rojos y naranjas, las fotografías tomadas son de absoluta belleza. Planifica tu visita para aprovechar los colores más espectaculares de la temporada.`,
    ...
    linkInterni: [
      ...
      { label: 'Paquete Fin de Semana, 2 Noches y Bancos', href: '/prenota', icon: 'fa-tag' },
    ],
...
Es un viaje corto pero lleno de vistas extraordinarias: hileras de hileras, pueblos y castillos que cuentan la historia de la identidad vitivinícola de Monferrato. Al regresar, el relax os espera en el hotel para acabar el día de la mejor forma posible.`,
      ...
      {
        titolo: 'Preguntas frecuentes: fechas, reservas y consejos útiles',
        testo: `La manifestación se celebra cada año durante el segundo fin de semana de mayo, habitualmente en torno al 8-10 de mayo. Las fechas oficiales son publicadas cada año por los organizadores en el sitio web del evento.
...
Consulta el sitio web oficial para conocer las fechas actualizadas de cada edición.`,
        lista: [
          'Cuándo: generalmente segundo fin de semana de mayo, habitualmente en torno al 8-10 de mayo (consulta las fechas oficiales en el sitio web)',
        ...
        links: [
          { label: 'Fechas y programa oficial — nizzaebarbera.wine', href: 'https://nizzaebarbera.wine/' },
        ],
        tags: ['Nizza es Barberá', 'Preguntas frecuentes sobre eventos de vino', 'Reservar el fin de semana en Monferrato'],
      },
    ],
    infoPratiche: {

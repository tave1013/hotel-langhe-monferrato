...
export const metadata = {
  ...
  description: 'Scopri Asti, Alba e il tartufo, Cattedrali Sotterranee di Canelli, castelli del Monferrato, Big Bench, E-bike, birrificio artigianale e Nizza è Barbera. Mini guide per il tuo soggiorno nelle Langhe.',
  openGraph: {
    ...
    <>
      ...
      <div style={{ background: '#1A1714', padding: '1.8rem 1.5rem' }}>
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          {[
            { icon: 'fa-map-marker-alt', num: '9', label: 'Mini Guide' },

  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden" style={{ padding: '90px 0' }}>
        <div className="absolute inset-0">
          <img src="/foto/alba.webp" alt="Alba Langhe Monferrato - cosa vedere vicino all'Hotel Langhe & Monferrato Costigliole d'Asti" className="w-full h-full object-cover" />

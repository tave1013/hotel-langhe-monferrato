          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
              ...
              <li style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                ...
                <a href="mailto:booking@hotellanghemonferrato.com" style={{ fontFamily: 'Lato', fontSize: '0.8rem', lineHeight: 1.5, color: 'rgba(255,255,255,0.55)', textDecoration: 'none', transition: 'color 0.2s' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = '#C9A870')}
                  onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(255,255,255,0.55)')}
                >
                  booking@hotellanghemonferrato.com
                </a>
              </li>
              {[

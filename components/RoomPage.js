              ...
              <div style={{ position: 'sticky', top: 100 }}>
                ...
                <div style={{ background: '#fff', padding: '1.3rem', borderTop: '1px solid rgba(201,168,112,0.2)' }}>
                  ...
                  {[
                    ...
                    { icon: 'fas fa-envelope', iconColor: '#C9A870', bg: 'rgba(201,168,112,0.1)', label: t(lang, 'roomPage.writeUs'), value: 'booking@hotellanghemonferrato.com', href: 'mailto:booking@hotellanghemonferrato.com' },
